...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "UAV_1/UGV_1/LED_Red") {
  ...
  if (String(topic) == "UAV_1/UGV_1/Sound") {
  ...
  if (String(topic) == "UAV_1/UGV_1/Control") {
...
//////////////////////////////      // Subscribe               /////////////////////////
      client.subscribe("UAV_1/UGV_1/LED_Red");
      client.subscribe("UAV_1/UGV_1/Sound");
      client.subscribe("UAV_1/UGV_1/Control");
...
//    Serial.println(tempString);
    client.publish("UAV_1/UGV_1/temperature", tempString);
...
//    Serial.println(humString);
    client.publish("UAV_1/UGV_1/humidity", humString);
  }
  if(!client.loop())
