...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "UAV_1/UGV_3/LED_Red") {
  ...
  if (String(topic) == "UAV_1/UGV_3/Sound") {
  ...
  if (String(topic) == "UAV_1/UGV_3/Control") {
...
//////////////////////////////      // Subscribe               /////////////////////////
      client.subscribe("UAV_1/UGV_3/LED_Red");
      client.subscribe("UAV_1/UGV_3/Sound");
      client.subscribe("UAV_1/UGV_3/Control");
...
//    Serial.println(tempString);
    client.publish("UAV_1/UGV_3/temperature", tempString);
...
//    Serial.println(humString);
    client.publish("UAV_1/UGV_3/humidity", humString);
  }
  if(!client.loop())
