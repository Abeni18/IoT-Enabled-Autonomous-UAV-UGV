...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "UAV_1/UGV_5/LED_Red") {
  ...
  if (String(topic) == "UAV_1/UGV_5/Sound") {
  ...
  if (String(topic) == "UAV_1/UGV_5/Control") {
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    */
    if (client.connect("ESP8266Client_5")) {
      Serial.println("connected");
//////////////////////////////      // Subscribe               /////////////////////////
      client.subscribe("UAV_1/UGV_5/LED_Red");
      client.subscribe("UAV_1/UGV_5/Sound");
      client.subscribe("UAV_1/UGV_5/Control");
...
//    Serial.println(tempString);
    client.publish("UAV_1/UGV_5/temperature", tempString);
...
//    Serial.println(humString);
    client.publish("UAV_1/UGV_5/humidity", humString);
  }
  if(!client.loop())
  client.connect("ESP8266Client_5");
}
