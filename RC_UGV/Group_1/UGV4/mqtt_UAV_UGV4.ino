...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "UAV_1/UGV_4/LED_Red") {
  ...
  if (String(topic) == "UAV_1/UGV_4/Sound") {
  ...
  if (String(topic) == "UAV_1/UGV_4/Control") {
...
//////////////////////////////      // Subscribe               /////////////////////////
      client.subscribe("UAV_1/UGV_4/LED_Red");
      client.subscribe("UAV_1/UGV_4/Sound");
      client.subscribe("UAV_1/UGV_4/Control");
...
//    Serial.println(tempString);
    client.publish("UAV_1/UGV_4/temperature", tempString);
...
//    Serial.println(humString);
    client.publish("UAV_1/UGV_4/humidity", humString);
  }
  if(!client.loop())
