...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "UAV_2/UGV_5/LED_Red") {
  ...
  if (String(topic) == "UAV_2/UGV_5/Sound") {
  ...
  if (String(topic) == "UAV_2/UGV_5/Control") {
...
//////////////////////////////      // Subscribe               /////////////////////////
      client.subscribe("UAV_2/UGV_5/LED_Red");
      client.subscribe("UAV_2/UGV_5/Sound");
      client.subscribe("UAV_2/UGV_5/Control");
...
//    Serial.println(tempString);
    client.publish("UAV_2/UGV_5/temperature", tempString);
...
//    Serial.println(humString);
    client.publish("UAV_2/UGV_5/humidity", humString);
  }
  if(!client.loop())
