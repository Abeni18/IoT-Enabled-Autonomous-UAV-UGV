...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "UAV_2/UGV_4/LED_Red") {
  ...
  if (String(topic) == "UAV_2/UGV_4/Sound") {
  ...
  if (String(topic) == "UAV_2/UGV_4/Control") {
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    */
    if (client.connect("ESP8266Client_4")) {
      Serial.println("connected");
//////////////////////////////      // Subscribe               /////////////////////////
      client.subscribe("UAV_2/UGV_4/LED_Red");
      client.subscribe("UAV_2/UGV_4/Sound");
      client.subscribe("UAV_2/UGV_4/Control");
...
//    Serial.println(tempString);
    client.publish("UAV_2/UGV_4/temperature", tempString);
...
//    Serial.println(humString);
    client.publish("UAV_2/UGV_4/humidity", humString);
  }
  if(!client.loop())
  client.connect("ESP8266Client_4");
}
